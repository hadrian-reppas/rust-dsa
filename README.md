...
| &#9989;  | Binomial Heap                        | [src/binomialheap.rs](https://github.com/hadrian-reppas/rust-dsa/blob/main/src/binomialheap.rs) | A [priority queue](http://en.wikipedia.org/wiki/Priority_queue) implementation backed by a [binomial heap](https://en.wikipedia.org/wiki/Binomial_heap). |
...
| &#9989;  | Fibonacci Heap                       | [src/fibheap.rs](https://github.com/hadrian-reppas/rust-dsa/blob/main/src/fibheap.rs) | A priority queue implementation backed by a [Fibonacci heap](http://en.wikipedia.org/wiki/Fibonacci_heap). |
